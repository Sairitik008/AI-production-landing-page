...
<p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color text-justify dark:border-white dark:border-opacity-25">
  Join our growing community of innovators and policymakers leveraging AI to
  build smarter, safer, and more efficient systems. 
</p>
